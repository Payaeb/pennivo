          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <button
                ...
                onClick={() =>
                  updateSetting("showWordCount", !settings.showWordCount)
                }
                role="switch"
