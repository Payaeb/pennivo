...
/**
 * One-time-per-file toast surfaced when `recovery:external-change-detected`
 * fires. Lives bottom-right above the statusbar; warm-amber accent on the
 * left edge — same family as the cap-exceeded toast / banner.
 *
...
export function ExternalChangeToast({
  ...
  return (
    <div
      className="external-change-toast"
      role="status"
      aria-live="polite"
    >
