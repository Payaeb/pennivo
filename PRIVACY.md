<!--
Canonical Pennivo privacy notice. The in-app About dialog renders the same
text from packages/ui/src/content/privacy.ts — keep that file in sync with
this one. The pennivo.app website should mirror this file as well.
-->

# Pennivo Privacy Notice
